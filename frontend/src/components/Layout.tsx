  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex min-h-screen">
        {/* Section 1: Sidebar */}
        <div
          className={`fixed inset-y-0 left-0 z-50 bg-white dark:bg-gray-800 shadow-xl transform transition-all duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 lg:z-auto lg:flex-shrink-0 lg:shadow-none ${
            sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
          } ${sidebarMinimized ? "w-16" : "w-64 sm:w-72"}`}
        >
          {/* Sidebar Header */}
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-600 to-blue-700">
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center px-3 sm:px-4 py-2 sm:py-3 text-sm font-medium rounded-xl transition-all duration-200 group ${
                      isActiveRoute
                        ? "bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-200 shadow-md"
        ...
        <button
          ...
          className="hidden lg:flex fixed top-4 z-50 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-r-lg p-2 shadow-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200"
          style={{
        ...
        <div className="flex-1 min-h-screen">
          {/* Top navigation */}
          <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30 h-16">
          ...
          {/* Page content */}
          <main className="bg-gray-50 dark:bg-gray-900 min-h-[calc(100vh-4rem)] p-4 sm:p-6 lg:p-8">
            <Outlet />
          </main>
        </div>
