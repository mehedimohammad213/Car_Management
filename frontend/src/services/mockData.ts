...
export const cars: Car[] = [
  ...
  },
  {
    ...
    mileage: 6500,
    description:
      "Premium SUV with quattro all-wheel drive and luxury features.",
    features: [
      "Quattro AWD",
      "Virtual Cockpit",
      "MMI Navigation Plus",
  ...
  },
  {
    ...
    mileage: 4500,
    description:
      "Executive luxury sedan with advanced driver assistance systems.",
    features: [
      "MBUX Hyperscreen",
  ...
  },
  {
    ...
    mileage: 18000,
    description:
      "Popular compact SUV with excellent reliability and fuel economy.",
    features: [
  ...
  },
  {
    ...
    transmission: "CVT",
    mileage: 22000,
    description: "Reliable compact sedan with sporty design and great value.",
    features: ["Honda Sensing", "Apple CarPlay", "Android Auto", "Sport Mode"],
    stock: 6,
    isAvailable: false,
  },
  {
    ...
    transmission: "Automatic",
    mileage: 9500,
    description: "Compact luxury SUV with dynamic performance and versatility.",
    features: [
      "xDrive AWD",
      "iDrive 7.0",
      "Live Cockpit Professional",
  ...
  },
  {
    ...
    features: ["Plaid Mode", "Autopilot", "Supercharging", "Glass Roof"],
    stock: 1,
    isAvailable: true,
  },
  {
    ...
    transmission: "Automatic",
    mileage: 3500,
    description: "High-performance sports car with quattro all-wheel drive.",
    features: [
      "Quattro AWD",
      "Sport Differential",
      "RS Sport Exhaust",
