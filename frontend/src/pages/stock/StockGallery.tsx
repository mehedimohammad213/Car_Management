    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-6">
      <div className="max-w-6xl mx-auto space-y-4 md:space-y-6">
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate(-1)}
            className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white shadow-md border border-gray-100 hover:-translate-y-0.5 transition-transform"
          >
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-2xl overflow-hidden relative">
              <div className="aspect-[4/3] bg-gray-100 relative">
                ...
                <div className="absolute top-3 left-3 flex flex-wrap gap-2">
                  ...
                  <span className="px-3 py-1.5 rounded-full text-xs font-semibold bg-white/80 backdrop-blur border border-gray-200 text-gray-800">
                    Qty: {stock.quantity}
                  </span>
                </div>
